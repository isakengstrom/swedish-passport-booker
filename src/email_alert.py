...
def send_booking_update_email(new_booked:str, prev_booked:str, new_expedition: str, prev_expedition:str, bookingId:str, bookingEmail:str):
    try:
        from_email_address = os.environ['devEmailAddress']
        from_email_password = os.environ['devEmailPassword']
        to_email_address = os.environ['notificationEmailAddress']
